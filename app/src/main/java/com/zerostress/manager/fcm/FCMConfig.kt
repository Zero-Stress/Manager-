...
object FCMConfig {
    ...
    fun checkFCMConfiguration(activity: Activity) {
        ...
        try {
            ...
            val tokenPreview = token?.let { it.substring(0, minOf(20, it.length)) }
        ...
        val notificationPermission = activity.checkSelfPermission(android.Manifest.permission.POST_NOTIFICATIONS)
        Log.d(
            TAG, "POST_NOTIFICATIONS permission: " +
